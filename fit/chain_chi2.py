...
def lnPosterior_chi(params, imfitter, p_bestfit,rmInd):
...
def run_emcee(args,p_bestfit, fitter,rmInd):
    ...
    sampler = emcee.EnsembleSampler(nwalkers, ndims, lnPosterior_chi, args=(fitter, lnPrior_func, rmInd))
    sampler.reset()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fitFile", type=str, help="name of fit result file")
    ...
    # run mcmc
    sampler = run_emcee(args, bestfits_n1[1],fitters_n1[1],rm_inds[1])
    # save chain
